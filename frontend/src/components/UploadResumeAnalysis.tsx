...
const UploadResumeAnalysis = ({ open, onOpenChange }: PdfUploadDialogProps) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response: any = await axios.post(
        "https://smartscan-production.up.railway.app/api/v1/resume/analyse-resume",
        formData,
        {
          headers: {
...
export default UploadResumeAnalysis;